    ...
    >
      ...
      >
        ...
        <motion.div
          ...
          style={{
            background:
              "conic-gradient(from 0deg, transparent 0deg, var(--color-primary) 90deg, transparent 180deg)",
        ...
        <motion.div
          ...
          style={{
            background:
              "conic-gradient(from 0deg, transparent 0deg, var(--color-primary-deep) 120deg, rgba(23,101,53,0.5) 240deg, transparent 360deg)",
        ...
        <motion.div
          ...
          style={{
            background:
              "conic-gradient(from 180deg, transparent 0deg, rgba(23,101,53,0.6) 45deg, transparent 90deg)",
        ...
        <motion.div
          ...
          style={{
            background:
              "conic-gradient(from 270deg, transparent 0deg, rgba(23,101,53,0.4) 20deg, transparent 40deg)",
      ...
      >
        ...
        <motion.h1
          ...
          className={cn(
            config.titleClass,
            "font-medium text-primary-deep leading-[1.15] tracking-[-0.02em] antialiased",
          )}
          initial={{ opacity: 0, y: 12 }}
          transition={{
            delay: 0.6,
