...
export const pageHeroes = {
  ...
  speakers: {
    ...
    title: "Speakers",
    description: "Learn from globally recognized experts sharing groundbreaking research in cardiovascular sciences.",
  ...
  contact: {
    ...
    image: "/images/Bg images/Cardial Green bg.png",
  ...
  awards: {
    ...
    description: "Oration names, symposium titles and award eligibility criteria are reproduced from the official brochure.",
    image: "/images/Bg images/Cardial Green bg.png",
